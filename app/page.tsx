          ...
          >
            <div className="pt-[95px] px-[24] h-auto lg:mb-[50px]">
              <Image
                ...
                className=""
              />
              <div className="text-white text-base sm:text-lg md:text-xl lg:text-xl font-black mt-[15px] mb-[50px] tracking-[0.2rem] text-center font-body">
                株式会社ドットログ
              </div>
            </div>
            <div className="font-black">
              <div className="text-white text-xs sm:text-xl md:text-2xl lg:text-4xl text-center tracking-[0.2rem] font-body">
                OUR MISSION
              </div>
              <div className="text-white text-2xl sm:text-4xl md:text-5xl lg:text-7xl mt-[10px] tracking-[0.5rem] md:tracking-[1.0rem] font-face">
                今日よりちょっと<br></br>やさしい明日を。
              </div>
            </div>
          </div>
                ...
                <div className="value flex">
                  <div className="relationship">
                    ...
                    <p className="relation-p3">
                      すべての「人、モノ、コト」とのご縁を大切にし、常に助け合いの精神で取り組む。
                    </p>
                  </div>
                  <div className="relationship">
        ...
        <section id="service" className="flex flex-col items-center">
          ...
          <AnimatedDiv className="service1 flex" direction="left">
            ...
            <div className="Alzuchi2">
              ...
              <p className="service1-contents">
                心理カウンセラー監修のAIを活用したメンタルヘルスケアアプリ「AIzuchi」AIとの会話を通じて自分をもっと知る事ができ、頭の中を整理することができる全く新しいジャーナリングアプリ
              </p>
              <p className="service1-botton2 btn-press">
                <a
                  href="https://aizuchi-lp.studio.site/"
                  rel="noopener"
                  target="_blank"
                  className="service1-botton1"
                >
                  サービスサイトへ
                </a>
              </p>
          ...
          <AnimatedDiv className="service2 flex" direction="right">
            ...
            <div className="Grab2">
              ...
              <p className="service2-contents1">
                Z世代ならでは視点から企業の「ブランディング」の側面を整理し、提供するサービスや会社自体に、より誇りを持っていただけるようサポートいたします。
              </p>
              <p className="service2-contents2">
                サブスク型ホームページ製作サービス
              </p>
    ...
    >
      ...
      />
            ...
            <div className="Alzuchi2">
              ...
              <p className="service1-contents">
                Instagram・TikTokにて、お悩み解消する情報やお出かけ情報など、人生をより豊かにするための情報を発信しております。
              </p>
            </div>
          </AnimatedDiv>
        </section>
      ...
      <footer>
        <div className="bg-black flex flex-col items-center h-[486px]">
          ...
          <div className="font-black mb-[100px] block">
            <Link
              href=""
              className="text-white inline-block text-xs md:text-xl px-3 hover:scale-90 hover:text-gray-200 duration-200"
            >
              トップ
            </Link>
            <Link
