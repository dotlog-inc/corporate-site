...
const ContactCard = () => {
  return (
    <div className="bg-gradient-to-br from-sky-200 to-red-200 md:px-[48px] px-[24px] py-[96px]">
        <div className="md:px-[48px] px-[0px] ">
            <div className="bg-white rounded-xl md:p-[96px] p-[48px] flex flex-col justify-center">
                ...
                <form action="" className="flex flex-col justify-center">
                    <div className="mb-6">
                        ...
                        <input type="text" placeholder="Your Name" className="bg-stone-100 h-[50px] w-full rounded-xl border border-stone-300 p-[12px]" required/>
                    </div>
                    <div className="mb-6">
                        <p className="font-black">メールアドレス</p>
                        <input type="email" placeholder="Email Addres" className="bg-stone-100 h-[50px] w-full rounded-xl border border-stone-300 p-[12px]" required/>
                    </div>
                    <div className="mb-6">
                    ...
                    <div className="mb-12">
                        ...
                        <textarea name="" id="" placeholder="Put message here" className="bg-stone-100 h-[160px] w-full rounded-xl border border-stone-300 p-[10px]" required></textarea>
                    </div>
